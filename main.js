...
const domElements = (() => {
    ...
    function buildEditForm (n, arrays) {
        ...
        inputTitle.className = 'inputTitle';
        inputTitle.autocomplete = 'off'
        inputTitle.value = _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox[n].title
        ...
        inputDescription.className = 'inputDescription';
        inputDescription.autocomplete = 'off';
        inputDescription.value = _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox[n].description
        ...
        inputDate.type = 'date'
        inputDate.autocomplete = 'off'
        inputDate.value = _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox[n].dueDate.split('-').reverse().join('-')
        ...
        for (let k, l = 0; k = selectPriority.options[l]; l++) {
            if (k.value === _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox[n].priority){
        ...
        for (let x, y = 0; x = chooseProject.options[y]; y++) {
            if (x.value === _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox[n].project) {
        ...
        submit.addEventListener('click', (e) => {
            if (inputTitle.value !== '' && inputDate !== '') {
                ...
                console.log(chooseProject.value)
                if (arrays = _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox) {
                    _item__WEBPACK_IMPORTED_MODULE_0__.items.editTodo(n,input1, input2, input3, input4, input5);
                    _list__WEBPACK_IMPORTED_MODULE_1__.currentTodo.editTodoTable(n)
                    e.preventDefault();
                    editFormTodo.reset();
                    removeEditForm();                    
                } 
...
const currentTodo = (() => {
    ...
    function newTodo (element, array) {
        for (let i = element.rows.length; i < array.length; i++) {
            ...
            editBtn.addEventListener('click', () => {
                if (_interface__WEBPACK_IMPORTED_MODULE_0__.domElements.editFormTodo.length === 0) {
                    _interface__WEBPACK_IMPORTED_MODULE_0__.domElements.buildEditForm(i, array)
                }
            })
    ...
    function editTodoTable(n) {
        ...
        title.textContent = _item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox[n].title
        dueDate.textContent = _item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox[n].dueDate
        priority.textContent = _item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox[n].priority
        description.textContent = _item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox[n].description
    }
        ...
        for (let i = element.rows.length + 1; i < array.length; i++) {
            ...
            btn.addEventListener('click', () => {
                for (let j = 0; j < _interface__WEBPACK_IMPORTED_MODULE_0__.domElements.tableTodo.rows.length; j++) {
                    ...
                    if (_interface__WEBPACK_IMPORTED_MODULE_0__.domElements.tableTodo.rows[j].attributes.value.nodeValue === btn.textContent) {
                        _interface__WEBPACK_IMPORTED_MODULE_0__.domElements.tableTodo.rows[j].style.display = 'table-row';
                    }
                }
            })
            ...
            function deleteProjectTodo (theProject) {
                for (let k = 0; k < _item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox.length; k++) {
                    if (theProject === _item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox[k].project) {
                        if (_item__WEBPACK_IMPORTED_MODULE_1__.items.arrInbox.length === 0) {
                            _item__WEBPACK_IMPORTED_MODULE_1__.items.deleteTodo(0);
                            _interface__WEBPACK_IMPORTED_MODULE_0__.domElements.tableTodo.deleteRow(0);
                        } else {
                            _item__WEBPACK_IMPORTED_MODULE_1__.items.deleteTodo(k);
                            _interface__WEBPACK_IMPORTED_MODULE_0__.domElements.tableTodo.deleteRow(k);
                        }
                    }
                }
            }
...
const homepage = (() => {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        for (let i = 0; i < oldTodo.length; i++) {
            ...
            _item__WEBPACK_IMPORTED_MODULE_0__.items.addOldTodo(input1, input2, input3, input4, input5)
        }

        let oldProject  = JSON.parse(localStorage.getItem('myArrProject'))
        for (let j = 1; j < oldProject.length; j++) {
            _item__WEBPACK_IMPORTED_MODULE_0__.items.addOldProject(oldProject[j])
        }

        _list__WEBPACK_IMPORTED_MODULE_2__.currentTodo.newTodo(_interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo , _item__WEBPACK_IMPORTED_MODULE_0__.items.arrInbox)
        _list__WEBPACK_IMPORTED_MODULE_2__.currentTodo.newProject(_interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableProject, _item__WEBPACK_IMPORTED_MODULE_0__.items.arrProject)
    })
    ...
    _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.todoBtn.addEventListener('click', () => {
        for (let i = 0; i < _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows.length; i++) {
            _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[i].style.display = 'table-row';
        }
    })
    ...
    _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.inboxBtn.addEventListener('click', () => {
        for (let j = 0; j < _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows.length; j++) {
            ...
            if (_interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].attributes.value.nodeValue === 'Inbox') {
                _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].style.display = 'table-row';
            }
        }
    })
    
    _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.todayBtn.addEventListener('click', () => {
        let thisDay = new Date()
        /*let day1 = String(thisDay.getDate())
        let month1 = String(thisDay.getMonth())
        let year1 = thisDay.getFullYear()*/
        let today = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(thisDay, 'dd-MM-yyyy')
        for (let j = 0; j < _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows.length; j++) {
            _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].style.display = 'none';
            if (_interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].attributes[0].nodeValue === today) {
                _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].style.display = 'table-row';
            }
        }
    })
    
    _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.thisWeekBtn.addEventListener('click', () => {
        let thisDay = new Date()
        let firstDay = thisDay.getDate() - thisDay.getDay() + 1
        let first = new Date(thisDay.setDate(firstDay))
        let starts = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(thisDay, 'dd,MM,yyyy')
    
        let endDay = new Date()
        let lastDay = firstDay + 7
        let last = new Date(endDay.setDate(lastDay))
        let ends = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(endDay, 'dd,MM,yyyy')
        
        for(let j = 0; j < _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows.length; j++) {
            _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].style.display = 'none';
            let current = _interface__WEBPACK_IMPORTED_MODULE_1__.domElements.tableTodo.rows[j].attributes[0].nodeValue
